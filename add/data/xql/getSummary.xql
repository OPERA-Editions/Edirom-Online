...
return
    ...
    then(local:getSourceSummary($doc, 'http://opera.uni-frankfurt.de:8089/digilib/Scaler/'))
    else if($type = 'text')
    then(local:getTextSummary($doc, 'http://opera.uni-frankfurt.de:8089/digilib/Scaler/'))
    else()
